---
permalink: /1.0.0/autoscaling/v1beta2/verticalPodAutoscalerCheckpoint/
---
...
* [`obj spec`](#obj-spec)
  * [`fn withContainerName(containerName)`](#fn-specwithcontainername)
  * [`fn withVpaObjectName(vpaObjectName)`](#fn-specwithvpaobjectname)
...
### fn spec.withVpaObjectName

```ts
withVpaObjectName(vpaObjectName)
```
